...
from .backbone import ResNet_8_2, DualBackbone
from .utils.position_encoding import PositionEncodingSine
from .osr_module import LocalFeatureTransformer, FineProcess, CoarseMatching, FineMatching
...
class OSR(nn.Module):
    def __init__(self, config):
        ...
        if config.get('use_dual_backbone', False):
